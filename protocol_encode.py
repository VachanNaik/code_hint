...
####added by vachan for transformer based bio bert
# Initialize BioBERT from Hugging Face
class BioBERT:
	def __init__(self, model_name='dmis-lab/biobert-base-cased-v1.1', max_length=2500):
